<template>
  <component
      ...
      v-bind="$attrs">
    <span key="underlay" class="foxy-card-header__underlay"/>
    
    <slot name="wrapper">
      <div v-if="hasPrepend" key="prepend" class="foxy-card-header__prepend" @click="handleClickPrepend">
        <slot name="prepend">
          <foxy-avatar
              v-if="prependAvatar"
              key="prepend-avatar"
      ...
      <div class="foxy-card-header__content" data-no-activator="">
        <div v-if="hasTitle" key="title" class="foxy-card-header__title">
          <slot name="title" v-bind="{ title }">{{ title }}</slot>
        </div>

        <div v-if="hasSubtitle" key="subtitle" class="foxy-card-header__subtitle">
      ...
      <div v-if="hasAppend" key="append" class="foxy-card-header__append" @click="handleClickAppend">
        <slot name="append">
          <foxy-avatar
              v-if="appendAvatar"
              key="append-avatar"
