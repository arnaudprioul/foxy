<template>
	...
	>
		...
		<template v-if="colorHsv">
			<div
					:class="{'foxui-color-picker-canvas__dot--disabled': disabled}"
					:style="dotStyles"
					class="foxui-color-picker-canvas__dot"
			/>
		</template>
	</div>
</template>
...
<script
		...
		setup
>
	import { useProps, useResizeObserver } from "@foxui/composables"

	import type { IColorPickerCanvasProps } from "@foxui/interfaces"

	import { clamp, convertToUnit, getEventCoordinates, int } from "@foxui/utils"
