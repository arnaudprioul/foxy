<template>
	...
	>
		...
		>
			<div
					class="foxui-color-picker-edit__field"
			>
				<input
						class="foxui-color-picker-edit__input"
						v-bind="{...inputProps}"
				/>
				<span class="foxui-color-picker-edit__label">{{ inputProps.label }}</span>
			</div>
		</template>
...
>
	...
	import { COLOR_NULL, COLOR_PICKER_MODES } from "@foxui/consts"

	import { COLOR_MODES_NAMES, MDI_ICONS } from "@foxui/enums"

	import type { IColorPickerEditProps } from "@foxui/interfaces"
