<template>
	...
	>
		<template
				...
				:key="_swatchIndex"
		>
			<div class="foxui-color-picker-swatches__swatch">
				<template
						v-for="(color, _colorIndex) in swatch"
						:key="_colorIndex"
				>
					<div
							class="foxui-color-picker-swatches__color"
...
>
	...
	import type { IColorPickerSwatchesProps } from "@foxui/interfaces"
	import type { TRGBA } from "@foxui/types"

	import { convertToUnit, deepEqual, getContrast, parseColor, RGBtoCSS, RGBtoHSV } from "@foxui/utils"
