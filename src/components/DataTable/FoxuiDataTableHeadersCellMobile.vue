<template>
	<tr class="foxui-data-table-headers__row">
		...
		>
			<template #default>
				<div class="foxui-data-table-headers-cell__content">
					<foxui-select
							:append-icon="appendIcon"
							:density="DENSITY.DEFAULT"
							:items="displayItems"
							:label="t('foxui.dataTable.sortBy')"
							:multiple="multiSort"
							chips
							class="foxui-data-table-headers-cell__sort-select"
							clearable
						...
						<template #chip="{ item, index, props: chipProps }">
							...
							>
								<foxui-chip
										...
										:class="[{'foxui-data-table-headers-cell__sort-chip--active': isSorted(item.raw)}]"
										:text="item.title"
										class="foxui-data-table-headers-cell__sort-chip"
										v-bind="chipProps"
...
<script
		...
		setup
>
	import { FoxuiChip, FoxuiDataTableColumnCell, FoxuiSelect } from '@foxui/components'

	import { useHeadersCell, useLocale, useProps, useSelection, useSort } from '@foxui/composables'

	import { DENSITY, MDI_ICONS } from '@foxui/enums'

	import type { IDataTableHeadersCellMobileProps, IInternalListItem } from '@foxui/interfaces'
