...
<script
		...
		setup
>
	import { OrigamBtn, OrigamReverseTranslatePicker, OrigamTransition, OrigamTranslatePicker } from "@origam/components"

	import { useCalendar, useDate, useProps } from "@origam/composables"

	import { CALENDAR_STRATEGY, DENSITY } from "@origam/enums"

	import type { IDatePickerMonthProps, IDay } from "@origam/interfaces"

	import type { TOrigamBtn, TTransitionProps } from "@origam/types"
