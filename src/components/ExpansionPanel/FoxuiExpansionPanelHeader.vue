<template>
	<component
			...
			@click="handleExpand"
	>
		<span class="foxui-expansion-panel-header__overlay"/>

		<div class="foxui-expansion-panel-header__wrapper">
      <span
		      v-if="hasPrepend"
		      key="prepend"
		      class="foxui-expansion-panel-header__prepend"
      ...
      >
        ...
        >
          ...
          />
			...
			<span
					v-if="hasTitle"
					class="foxui-expansion-panel-header__title"
			>
        <slot
		        name="default"
		        v-bind="slotProps"
        >
          {{ title }}
			...
			<span
					...
					key="append"
					class="foxui-expansion-panel-header__append"
...
>
	...
	import type { IExpansionPanelHeaderProps } from '@foxui/interfaces'
	...
	const expansionPanelHeaderClasses = computed(() => {
		return [
			...
			{
				'foxui-expansion-panel-header--active': expansionPanel.isSelected.value,
				'foxui-expansion-panel-header--focusable': props.focusable,
				'foxui-expansion-panel-header--static': props.static
			},
			borderClasses.value,
