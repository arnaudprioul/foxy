<template>
	...
	>
      ...
      <span
		      v-if="hasPrepend"
		      key="prepend"
		      class="foxy-expansion-panel-header__prepend"
      ...
      >
        ...
        >
          ...
          />
			...
			<span
					v-if="hasTitle"
					class="foxy-expansion-panel-header__title"
			>
        <slot
		        name="default"
		        v-bind="slotProps"
        >
          {{ title }}
			...
			<span
					...
					key="append"
					class="foxy-expansion-panel-header__append"
...
>
	...
	import type { IExpansionPanelHeaderProps } from '@foxy/interfaces'
