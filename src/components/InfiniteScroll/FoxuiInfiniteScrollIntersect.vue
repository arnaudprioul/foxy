<template>
	<div
			ref="intersectionRef"
			class="foxui-infinite-scroll-intersect"
	>&nbsp;
	</div>
</template>
...
<script
		...
		setup
>
	import { useIntersectionObserver, useProps } from '@foxui/composables'

	import type { IInfiniteScrollIntersectProps } from '@foxui/interfaces'
