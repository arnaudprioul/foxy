<template>
  ...
  >
    <span
        ...
        key="overlay"
        class="foxy-list-item__overlay"
    />
    <span
        key="underlay"
        class="foxy-list-item__underlay"
    />
    ...
    <slot name="wrapper">
      ...
      <div
          class="foxy-list-item__content"
          data-no-activator=""
      >
        <div
            v-if="hasTitle"
            key="title"
            class="foxy-list-item__title"
        >
          <slot
              name="title"
              v-bind="{ title }"
        ...
        <div
            v-if="hasSubtitle"
            key="subtitle"
            class="foxy-list-item__subtitle"
        >
          <slot
              name="subtitle"
              v-bind="{ subtitle }"
...
>
  ...
  import { computed, onBeforeMount, StyleValue, toRef, useAttrs, watch, useSlots } from 'vue'
  ...
  const lineClasses = computed(() => {
    return [
      props.lines ? `foxy-list-item--${props.lines}-line` : undefined
    ]
  })
