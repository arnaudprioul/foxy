...
<script
		...
		setup
>
	import { FoxuiFade, FoxuiOverlayScrim, FoxuiTransition } from '@foxui/components'
	...
	import { vClickOutside } from '@foxui/directives'

	import { BLOCK, EASING, KEYBOARD_VALUES, LOCATION_STRATEGIES, SCROLL_STRATEGIES } from '@foxui/enums'

	import type { IOverlayProps } from '@foxui/interfaces'

	import type { TFoxuiOverlayScrim, TTransitionProps } from "@foxui/types"

	import { animate, convertToUnit, getScrollParent } from '@foxui/utils'
	...
	const scrimEl = ref<TFoxuiOverlayScrim>()
	...
	const overlayClasses = computed(() => {
		return [
			'foxui-overlay',
			{
				'foxui-overlay--absolute': props.absolute || props.contained,
				'foxui-overlay--active': isActive.value,
				'foxui-overlay--contained': props.contained
			},
			rtlClasses.value,
			props.class
		]
