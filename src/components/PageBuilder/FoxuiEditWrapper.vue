<template>
	...
	>
		<div class="foxui-edit-wrapper__wrapper">
			<slot name="default"/>
		</div>
	</div>
</template>
...
>
	...
	import type { IAutoPropComponentDefinition, IEditWrapperProps } from '@foxui/interfaces'
	import { scanForAutoProps } from '@foxui/utils'
