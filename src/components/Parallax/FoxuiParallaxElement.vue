...
<script
		...
		setup
>
	import { useParallaxTransform, useProps } from '@foxui/composables'

	import { FOXUI_PARALLAX_KEY } from '@foxui/consts'

	import { AXIS, PARALLAX_ELEMENT_TYPE } from '@foxui/enums'

	import type { IParallaxElementProps } from '@foxui/interfaces'

	import { cyclicMovement, elementMovement } from '@foxui/utils'
	...
	const parallax = inject(FOXUI_PARALLAX_KEY)

	if (!parallax) throw new Error('[Foxui] parallax-element needs to be placed inside parallax')
