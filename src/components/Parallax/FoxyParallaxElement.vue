...
<script lang="ts" setup>
  ...
  import { IParallaxElementProps } from '@foxy/interfaces'

  import { cyclicMovement, elementMovement } from '@foxy/utils'
  ...
  if (!parallax) throw new Error('[Foxy] parallax-element needs to be placed inside parallax')
