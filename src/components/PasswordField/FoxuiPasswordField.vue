			...
			>
				...
				>
					...
					<template #appendInner>
						<div
								class="foxui-password-field__toggle-icon"
...
<script
		...
		setup
>
	import { FoxuiCounter, FoxuiField, FoxuiIcon, FoxuiInput } from '@foxui/components'
	...
	import type { IPasswordFieldProps } from '@foxui/interfaces'
