	...
	>
		...
		>
			<circle
					...
					class="foxui-progress__underlay"
					cx="50%"
					cy="50%"
					fill="transparent"
					stroke-dashoffset="0"
...
>
	...
	import { CIRCUMFERENCE, MAGIC_RADIUS } from '@foxui/consts'

	import type { IProgressCircularProps } from '@foxui/interfaces'
