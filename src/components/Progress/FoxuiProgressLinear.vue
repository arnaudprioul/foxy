<template>
	...
	>
		<div
				...
				key="stream"
				:style="streamStyles"
				class="foxui-progress__stream"
		/>
		<div
				:style="backgroundStyles"
				class="foxui-progress__background"
		/>

		<foxui-transition :transition="transition">
			<div class="foxui-progress__loader">
				<template v-if="indeterminate">
					<div
							v-for="bar in ['long', 'short']"
							:key="bar"
							:class="`foxui-progress__bar--${bar}`"
							:style="loaderStyles"
							class="foxui-progress__bar"
					/>
				</template>
				<template v-else>
					<div
...
<script
		...
		setup
>
	import { FoxuiFade, FoxuiSlideX, FoxuiTransition } from '@foxui/components'
	...
	import type { IProgressLinearProps } from '@foxui/interfaces'
	...
	const transition = computed(() => {
		return props.indeterminate ? {component: FoxuiFade} : {component: FoxuiSlideX}
	})
	...
	const progressLinearClasses = computed(() => {
		return [
			...
			{
				'foxui-progress--reverse': isReversed.value,
				'foxui-progress--rounded': props.rounded
			},
			rtlClasses.value,
