...
<script
		...
		setup
>
	import { FoxuiInput, FoxuiRadioBtn } from '@foxui/components'

	import { useFocus, useProps, useVModel } from '@foxui/composables'

	import { DENSITY } from '@foxui/enums'

	import type { IRadioProps } from '@foxui/interfaces'

	import type { TFoxuiInput, TFoxuiRadioBtn } from "@foxui/types"
	...
	const foxuiRadioBtnRef = ref<TFoxuiRadioBtn>()
	...
	const radioBtnProps = computed(() => {
		return foxuiRadioBtnRef.value?.filterProps(props, ['modelValue', 'class', 'style', 'id', 'disabled', 'readonly', 'error'])
	})
