<template>
  <div :class="responsiveClasses" :style="responsiveStyles">
    <div :style="aspectStyles" class="foxy-responsive__sizer"/>
    <slot name="additional"/>
    <div v-if="hasSlot('default')" :class="responsiveContentClasses">
      <slot name="default"/>
    </div>
  </div>
</template>
