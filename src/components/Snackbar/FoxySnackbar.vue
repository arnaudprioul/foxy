<template>
	...
	>
      ...
      <span
		      key="underlay"
		      class="foxy-snackbar__underlay"
      />

			<div
					v-if="props.timer && !isHovering"
					key="timer"
					class="foxy-snackbar__timer"
			>
				<foxy-progress
						ref="foxyProgressRef"
						:max="props.timeout"
...
>
	...
	import type { ISnackbarProps } from "@foxy/interfaces"

	import type { TFoxyOverlay, TFoxyProgress, TIcon, TTransitionProps } from '@foxy/types'
