...
>
	...
	import { EASING, TRANSITION_MODE } from '@foxui/enums'

	import type { ITranslateScaleProps } from '@foxui/interfaces'

	import { animate, getChildren, getDimensions } from '@foxui/utils'

	import { computed } from 'vue'

	const props = withDefaults(defineProps<ITranslateScaleProps>(), {
		name: 'foxui-transition--transform-scale',
...
<style lang="scss">
	.foxui-transition--transform-scale {
		&-enter-active {
