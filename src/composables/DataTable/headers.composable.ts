...
import { IDataTableHeader, IDataTableHeaderProps, IHeaderCellProps, IInternalDataTableHeader, IDataTableSortItem } from '@foxy/interfaces'

import { TDataTableCompareFunction, TFilterKeyFunctions } from '@foxy/types'
