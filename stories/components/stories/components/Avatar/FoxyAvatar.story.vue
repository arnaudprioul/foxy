...
<script
		...
		setup
>
	import { FoxuiAvatar, FoxuiCol, FoxuiContainer, FoxuiRow } from '@foxui/components'
	import { JUSTIFY, MDI_ICONS } from "@foxui/enums"
	import type { IAvatarProps } from "@foxui/interfaces"
	import {
		HstBorder,
		HstColor,
		HstDensity,
	...
	const state: Partial<IAvatarProps> = reactive({
	...
	const icon = ref(MDI_ICONS.GOOGLE)
	const image = ref(new URL('/public/logo.svg', import.meta.url).href)
	const text = ref('AP')
</script>
