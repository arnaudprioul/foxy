...
<script lang="ts" setup>
  import { FoxyCol, FoxyContainer, FoxyIcon, FoxyRow } from '@foxy/components'
...
<docs lang="md">
The badge component superscripts or subscripts an avatar-like icon or text onto content to highlight information to a user or to just draw attention to a specific element. Content within the badge usually contains numbers, text or icons.
