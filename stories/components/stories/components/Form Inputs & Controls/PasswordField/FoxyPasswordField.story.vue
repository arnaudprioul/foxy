<template>
	<Story
			auto-props-disabled
			group="components"
			title="Form Inputs & Controls/PasswordField"
	>
		<Variant title="Default">
			...
			<template #controls>
				...
				<hst-icon v-model="state.offIcon" title="Off Icon"/>
				<hst-icon v-model="state.onIcon" title="On Icon"/>
...
<script lang="ts" setup>
	import { FoxyCol, FoxyContainer, FoxyPasswordField, FoxyRow, FoxyTextField } from '@foxy/components'
